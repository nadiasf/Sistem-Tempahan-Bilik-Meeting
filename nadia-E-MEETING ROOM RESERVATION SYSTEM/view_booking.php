...
<h3 style="text-align:left;color:black;margin-left:70px ;font-family:Times New Roman"> Booking Details</h3>
 ...
 <div>
		 	...
		 	<form action="details_booking.php" method="post" style="margin-top:30px;">
			    ...
			    <label>Order No. :</label><label style="margin-left: 70px"><?php if(isset($ref_number)){ echo $ref_number;}?></label><br><br>
				...
				<a href="viewreg_user.php" class="pay">Back</a>
				<a href="form.php?id=<?php if(isset($ref_number)){ echo $ref_number;} ?>" class="print">Print</a>
