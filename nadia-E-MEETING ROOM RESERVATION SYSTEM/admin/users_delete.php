...
if(isset($_GET['deleteid'])){
	echo 'Do you really want to delete user with ID of &nbsp; '.$_GET['deleteid'].' &nbsp;?&nbsp; <a style="color:blue;text-decoration:none;" href="users_delete.php?yesdelete='.$_GET['deleteid'].'">&nbsp;Yes</a> | <a style="color:Red;text-decoration:none;" href="users_list.php">No</a>';
}
if(isset($_GET['yesdelete'])){
	$id_to_delete=$_GET['yesdelete'];
    $sql=mysql_query("DELETE FROM `user` WHERE `user`.`id`='".$id_to_delete."' limit 1") or die(mysql_error());  
	echo 'Delete User Done . Back to Users List <a href="users_list.php" style="color:blue;">Click Here</a>';
}
?>
</div>
