...
if($productcount>0){
	while($rows=mysql_fetch_array($sql)){
		...
		$product_list.="<p style='border-bottom:1px dotted #F37232; '>$date_added | $id | $product_name&nbsp | $product_price RM | $sale_price RM | $color | $size | $status&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='inventory_edit.php?pid=$id'>Edit</a>&nbsp;|&nbsp;<a href='inventory_delete.php?deleteid=$id'>Delete</a><br/></p>";
	}
}else{
...
<a style="text-decoration:none; color:#00F;" href="inventory_form.php">+ Add New Inventory Item</a>
</div>
<div class="admin">
<h2>Inventory List</h2>
<p style="color:#666; border-bottom:1px solid #F37232;">Date Added | ID | Product Name | Product Price | Sale Price | Color | Size | Status</p>
