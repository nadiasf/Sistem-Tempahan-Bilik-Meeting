...
$users_list='';
$sql=mysql_query("select * from user order by register_date desc");
...
if($usercount>0){
	while($rows=mysql_fetch_array($sql)){
		...
		$users_list.="<p style='border-bottom:1px dotted #F37232; '>$register_date | $id | $email&nbsp | $username | $password &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href='users_edit.php?pid=$id'>Edit</a>&nbsp;|&nbsp;<a href='users_delete.php?deleteid=$id'>Delete</a><br/></p>";
	}
}else{
	$users_list='You have no Users listed in your store yet .';
}
?>
...
<a style="text-decoration:none; color:#00F;" href="users_form.php">+ Add New User</a>
</div>
<div class="user">
<h2>Users List</h2>
<p style="color:#666; border-bottom:1px solid #F37232;">Date Added | ID | Email | Username | Password </p>
<?php echo $users_list;?>
</div>       
      </div>
